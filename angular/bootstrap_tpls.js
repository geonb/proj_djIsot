    ...
    .controller('UibCarouselController', ['$scope', '$rootScope', '$element', '$interval', '$timeout', '$animate', function ($scope, $rootScope, $element, $interval, $timeout, $animate) {
        ...
        self.addSlide = function (slide, element) {
            ...
            if (slide.index === $scope.active || slides.length === 1 && !angular.isNumber($scope.active)) {
                ...
                $rootScope.storeProj.it[currentIndex] = 0;
...
angular.module("uib/template/carousel/carousel.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("uib/template/carousel/carousel.html",
        ...
        "  <li ng-repeat=\"slide in slides | orderBy:indexOfSlide track by $index\" ng-class=\"{ active: isActive(slide) }\" id=\"cslide_{{$index}}\" ng-click=\"select(slide)\">\n" +
